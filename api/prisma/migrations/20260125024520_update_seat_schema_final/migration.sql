/*
  ...
  - The values [LOCKED] on the enum `SeatStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SeatStatus_new" AS ENUM ('AVAILABLE', 'DISABLED');
