...
interface DashboardTripCardProps {
    booking: Booking;
    showStatus?: boolean; // Kept for compatibility but default to true if syncing
}

export function DashboardTripCard({ booking, showStatus = true }: DashboardTripCardProps) {
