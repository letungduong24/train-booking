...
export function LoginForm({
  ...
  const onSubmit = async (data: LoginFormData) => {
    try {
      ...
      // Login using Zustand store - tokens are stored in httpOnly cookies automatically
            ...
            <FieldGroup className="gap-5">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest">
                  <span className="bg-white dark:bg-zinc-900 px-3 text-muted-foreground/40">Hoặc tiếp tục với email</span>
                </div>
              </div>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <Link
                    ...
                    className="ml-auto text-xs font-semibold text-[#802222] hover:underline underline-offset-4"
                  >
                    Quên mật khẩu?
                  </Link>
                </div>
              ...
              <Field className="pt-2">
                ...
                <div className="text-center mt-6">
                  <p className="text-xs font-semibold text-muted-foreground/60">
                    Chưa có tài khoản?{" "}
                    <Link href="/register" className="text-[#802222] hover:underline underline-offset-4 font-bold">
                        Đăng ký miễn phí
                    </Link>
                  </p>
                </div>
