...
- **Chatbot AI (Trợ lý ảo):** Trợ lý ảo xử lý và trả lời thông minh các câu hỏi của khách hàng.

---

## 2. Danh Mục 22 Use Cases Khái Quát
...
### 2.2 Phân hệ Quản trị (Admin) - 8 UCs
...
- **4.2 Phân hệ Quản trị (Admin):**
  ...
  - [UC-13: Quản lý trạng thái ghế](file:///c:/Study/train-booking/diagrams/usecases/specifications/13-quan-ly-trang-thai-ghe.md)
  ...
  - [UC-20: Quản lý dữ liệu mạng lưới đường sắt](file:///c:/Study/train-booking/diagrams/usecases/specifications/20-quan-ly-co-so-ha-tang.md)
  - [UC-21: Xử lý sự cố ghế hỏng](file:///c:/Study/train-booking/diagrams/usecases/specifications/21-xu-ly-su-co-ghe-hong.md)
  - [UC-22: Xử lý báo cáo delay chuyến tàu](file:///c:/Study/train-booking/diagrams/usecases/specifications/22-xu-ly-delay-chuyen-tau.md)
